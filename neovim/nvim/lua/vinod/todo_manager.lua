...
-- MODEL TODO BUILDER
-- ========================================
-- Show model dialog for todo creation with all fields in one window.
function M.show_todo_modal()
  -- Form state
  local form_data = {
    description = "",
  ...
  --Create floating window (400x300px) with form fields
  --TODO: Implement floating window creation
  ...
  local function handle_input()
    ...
    vim.keymap.set("n", "3", function()
      M.get_date_input(function(picked_date)
        if picked_date then -- User didn't cancel
          form_data.show_date = picked_date
          render_form() -- Refresh display
        end
      end)
    end, { buffer = buf, silent = true })
