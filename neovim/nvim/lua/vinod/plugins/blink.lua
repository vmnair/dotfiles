return {
	...
	opts = {
		...
		completion = {
			...
			trigger = {
				prefetch_on_insert = true, -- Prefetch items on entering insert
				show_on_insert = false, -- Do not show on entering insert mode
				show_in_snippet = false, -- Do not show in snippets
				show_on_backspace = false,
				show_on_backspace_in_keyword = false,
				show_on_backspace_after_accept = true, -- backspacing into keyword
